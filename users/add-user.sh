...
sed -e "s|<USER>|$USERNM|" -e "s|<NAMESPACE>|$USERNM|" -e "s|<KEY>|$KEY_DATA|" -e "s|<CERTIFICATE>|$USER_CRT|" -e "s|<CA>|$CA_DATA|" -e "s|<SERVER>|$SERVER_DATA|" $(dirname "$0")/kubeconfig-template.yaml > $(dirname "$0")/.kubeconfig-$USERNM.yaml
